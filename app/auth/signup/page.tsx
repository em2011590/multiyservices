      ...
      >
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            <p className="text-gray-400">Join DevSphere and unlock advanced features</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="space-y-3 mb-6">
            <button className="w-full bg-white/10 hover:bg-white/20 text-white font-semibold py-2 rounded-lg transition-colors flex items-center justify-center gap-2 border border-white/10">
